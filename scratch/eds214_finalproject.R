...
relevant_bq2 <- bq2_data|> select(Sample_ID, Sample_Date, K, `NO3-N`, Mg, Ca, `NH4-N`)
relevant_bq3 <- bq3_data|> select(Sample_ID, Sample_Date, K, `NO3-N`, Mg, Ca, `NH4-N`)
...
# Moving averages example from EDS221 Day 10
